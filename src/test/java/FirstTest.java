...
public class FirstTest {
    ...
    public static void setUp(){
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Magdalena\\Desktop\\Ćwiczenia\\chromedriver.exe");
    ...
    public void pocztaWpPl(){
        ...
        driver.findElement(By.xpath("//*[@id=\"stgMain\"]/div/div/div[1]/form/button"));
        Assertions.assertEquals("Poczta - Najlepsza Poczta, największe załączniki - WP",driver.getTitle());
    }
